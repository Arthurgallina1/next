export default function Navbar() {
    return (
        // <div className='px-14 bg-white flex justify-between'>
        ...
        //             <li className='m-5 text-gray-600'>Home</li>
        //             <li className='m-5 text-gray-600'>Sobre</li>
        //             <li className='m-5 text-gray-600'>Projetos</li>
        //         </ul>
        //     </div>
        // </div>
